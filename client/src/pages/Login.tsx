                ...
                <div className="container mx-auto max-w-6xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div
                            ...
                            style={{
                                backgroundImage: `linear-gradient(rgba(255, 255,
                                255, 0.5), rgba(255,255,255,0.9)),
                                url(${authBg})`,
                                backgroundSize: "cover",
                                backgroundPosition: "center"
                            }}
                        >
                            <div className="relative z-10 text-center">
                                ...
                                <p className="text-lg mb-6 text-gray-700 max-w-lg mx-auto">
                                    Sign in to access your library management
                                    dashboard and continue streamlining your
                                    library operations.
                                </p>
                            </div>
                        </div>
